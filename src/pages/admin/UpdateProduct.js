...
import { addProductDetails } from "../../redux/productSlice/productSlice";
...
const UpdateProduct = () => {
    ...
    axios
      ...
      .then((res) => {
        ...
        product.images.forEach((image)=>{
            imagePreview.push(image.url)
        })
      })
      .catch((err) => {
        toast.error(err.message);
      });
  }, [id, dispatch,product,imagePreview]);
  ...
  const submitHandler = (e) => {
    ...
    axios
      .put(`${server}/admin/product/edit/${id}`, formData, { withCredentials: true })
      .then((res) => {
        dispatch(setLoading(false));
        toast.success(res.data.message);
        dispatch(addProductDetails(res.data.updatedProduct))
      })
      .catch((err) => {
        dispatch(setLoading(false));
